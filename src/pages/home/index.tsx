    ...
    description: (
      <>
        <div style={{fontSize:"1.2rem", marginBottom:"1.5rem"}}>
          Explore my daily learning journey with frontend and JavaScript concepts. Each spark represents a moment of discovery and growth.
        </div>
        <Link href="/blog" style={{textDecoration: "none"}}>
          ...
          >
            <Icon icon="fluent:sparkle-28-regular" style={{fontSize: "1.2rem"}} />
